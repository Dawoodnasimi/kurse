...
class KurseController extends AbstractController
{
    ...
    #[Route('/kurse/kurs_erstellen', name: 'kurs_erstellen')]
    public function create(EntityManagerInterface $entityManager, $form): Response
    {
        $kurs = new Kurse();
        $form->$entityManager->createForm(KursFormType::class, $kurs);
